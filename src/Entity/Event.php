...
class Event
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Reservation::class, mappedBy: 'event_id', cascade: ['remove'], orphanRemoval: true)]
    private Collection $reservations;

    #[ORM\ManyToOne(inversedBy: 'events')]
    private ?HRMClub $hrm_club = null;
    ...
    public function getHrmClub(): ?HRMClub
    {
        return $this->hrm_club;
    }

    public function setHrmClub(?HRMClub $hrm_club): static
    {
        $this->hrm_club = $hrm_club;
