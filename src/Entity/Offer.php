...
class Offer
{
    ...
    #[ORM\ManyToOne(targetEntity: HRM::class, inversedBy: 'offers')]
    #[ORM\JoinColumn(nullable: false, name: 'id_hrm', referencedColumnName: 'id')]
    #[Assert\NotNull(message: 'HRM is required')]
    private ?HRM $hrm = null;
    ...
    public function getHrm(): ?HRM
    {
        return $this->hrm;
    }

    public function setHrm(?HRM $hrm): static
    {
        $this->hrm = $hrm;
